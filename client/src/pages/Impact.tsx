...
const impactAreas = [
  ...
  },
  {
    ...
    text: "We strengthen the knowledge, skills, resilience and capacity of families and caregivers.",
  },
  {
    icon: ShieldCheck,
    title: "Child Protection",
    text: "We promote children's rights, safety and dignity while strengthening protective environments.",
  },
];
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="rounded-[32px] border border-white/5 bg-[#111A2D] p-8 md:p-10">
              ...
              <p className="mt-6 leading-7 text-[#AEB9CD]">
                We pursue this through integrated interventions, partnerships,
        ...
        <div className="ftf-container ftf-section">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {impactAreas.map((area) => {
              ...
              return (
                <div key={area.title} className="ftf-card p-8">
      ...
      <section className="border-y border-white/5 bg-[#091023]">
        <div className="ftf-container ftf-section">
          ...
          <div className="mx-auto mt-12 grid max-w-6xl gap-4 md:grid-cols-4">
            {[
              ["01", "Opportunities", "Meaningful learning opportunities"],
              ["02", "Strength", "Stronger families and caregivers"],
              ["03", "Safety", "Safe and protective environments"],
              ["04", "Outcomes", "Improved well-being and opportunity"],
            ].map(([number, title, text]) => (
              <div
                key={number}
                className="rounded-3xl border border-white/5 bg-[#111A2D] p-7 text-center"
              >
        ...
        <div className="ftf-container">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {principles.map((principle) => {
              ...
              return (
                <div key={principle.title} className="ftf-card p-7">
      ...
      <section className="border-t border-white/5 bg-[#050817]">
        <div className="ftf-container py-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-[#AEB9CD]">
            Stronger outcomes are possible when communities, organisations and
            individuals work together around a shared purpose.
          </p>
