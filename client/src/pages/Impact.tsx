        ...
        <div className="ftf-container relative py-24 md:py-32">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-5 font-['Poppins'] text-4xl font-extrabold leading-tight text-white md:text-6xl">
              ...
              <span className="text-[#4DD0E1]">understood and improved.</span>
            </h1>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="ftf-card p-7">
              ...
              <p className="mt-3 leading-7 text-[#AEB9CD]">
                Children have meaningful opportunities to learn and develop
            ...
            <div className="ftf-card p-7">
              ...
              <p className="mt-3 leading-7 text-[#AEB9CD]">
                Families and caregivers have stronger capacity to support
            ...
            <div className="ftf-card p-7">
              ...
              <p className="mt-3 leading-7 text-[#AEB9CD]">
                Children experience safer, more protective environments where
              ...
              <div className="mt-7 space-y-4">
                {measurementAreas.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-[#D8DCEF]">{item}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="ftf-container">
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-[#1D293E] to-[#11182B] p-8 md:p-12">
            ...
            <div className="relative max-w-3xl">
              ...
              <span className="mt-6 block font-['Poppins'] text-sm font-bold uppercase tracking-[0.2em] text-orange-400">
                Looking Ahead
              </span>
      ...
      <section className="ftf-section bg-[#050817]">
        <div className="ftf-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 leading-7 text-[#AEB9CD]">
              Stronger outcomes become possible when communities,
              organisations, and individuals work together.
            </p>
