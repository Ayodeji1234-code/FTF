  ...
  return (
    <main className="ftf-page">
      ...
      <section className="relative min-h-[calc(100vh-80px)] overflow-hidden">
        ...
        <div className="ftf-container relative flex min-h-[calc(100vh-80px)] items-center py-16 lg:py-20">
          <div className="grid w-full items-center gap-14 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="ftf-fade-up">
              ...
              {/* ================= BRAND PILL ================= */}
              <div className="mb-8 inline-flex items-center gap-4 rounded-full border border-[#4DD0E1]/25 bg-[#4DD0E1]/5 px-4 py-2.5 backdrop-blur-md">

                {/* Actual FTF Logo */}
                <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#050817] ring-1 ring-[#4DD0E1]/20">
                  <img
                    src="/logo.png"
                    alt="Favored Tribe Foundation logo"
                    className="h-10 w-10 object-contain brightness-125 contrast-110"
                  />
                </div>

                <span className="font-['Poppins'] text-sm font-extrabold tracking-wide text-[#4DD0E1] md:text-base">
                  FAVORED TRIBE FOUNDATION
                </span>
              </div>

              {/* ================= MAIN HEADING ================= */}
              <h1 className="max-w-3xl font-['Poppins'] text-5xl font-extrabold leading-[0.98] tracking-[-0.03em] text-[#F1F3FA] sm:text-6xl lg:text-[76px]">
                Creating hope.
                <br />
              ...
              {/* ================= DESCRIPTION ================= */}
              <p className="mt-7 max-w-2xl text-lg leading-8 text-[#AEB9CD] md:text-xl">
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <Link
                  to="/get-involved"
                  className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#6735C5] px-8 py-4 font-['Poppins'] font-bold text-white shadow-[0_10px_30px_rgba(103,53,197,0.25)] transition duration-300 hover:-translate-y-1 hover:bg-[#7545D5] hover:shadow-[0_15px_40px_rgba(103,53,197,0.35)]"
                >
                  Get Involved
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/[0.02] px-8 py-4 font-['Poppins'] font-bold text-[#E7EAF3] transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05]"
                >
                  Discover Our Story
                </Link>
              </div>
              ...
              <div className="mt-10 flex flex-wrap gap-x-8 gap-y-4">
                {values.map((value) => (
                  ...
                  >
                    <CheckCircle2 className="h-[18px] w-[18px] text-[#4DD0E1]" />
            ...
            <div className="relative hidden lg:block">
              ...
              {/* Outer glass frame */}
              <div className="relative mx-auto max-w-[545px] rounded-[38px] border border-white/10 bg-[#18233A] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.3)]">

                {/* Inner card */}
                <div className="rounded-[30px] border border-white/5 bg-[#080D1E] p-9">

                  {/* ================= LOGO ================= */}
                  <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl bg-[#5E35B1]/20 ring-1 ring-[#4DD0E1]/10">
                    <img
                      src="/logo.png"
                      alt="Favored Tribe Foundation logo"
                      className="h-14 w-14 object-contain brightness-125 contrast-110"
                    />
                  </div>

                  {/* ================= LABEL ================= */}
                  <p className="mt-8 font-['Poppins'] text-sm font-bold tracking-[0.28em] text-[#4DD0E1]">
                    OUR PURPOSE
                  </p>

                  {/* ================= HEADING ================= */}
                  <h2 className="mt-4 font-['Poppins'] text-3xl font-bold leading-tight text-[#E9ECF5]">
                    Every child deserves the opportunity to thrive.
                  </h2>

                  {/* ================= TEXT ================= */}
                  <p className="mt-4 text-base leading-7 text-[#AEB9CD]">
                  ...
                  {/* ================= TAGLINE ================= */}
                  <p className="font-['Poppins'] text-lg font-bold text-[#F1F3FA]">
                    Transforming Futures
                  </p>

                  <p className="mt-2 font-['Poppins'] text-lg font-bold text-[#4DD0E1]">
                    Through Kindness
                  </p>
                </div>
              </div>
              ...
              {/* Decorative glow */}
              <div className="absolute -right-10 -top-10 -z-10 h-44 w-44 rounded-full bg-[#5E35B1]/20 blur-[80px]" />
              <div className="absolute -bottom-10 -left-10 -z-10 h-44 w-44 rounded-full bg-[#4DD0E1]/10 blur-[80px]" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="ftf-container ftf-section">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <Link
                to="/about"
                className="mt-6 inline-flex items-center gap-2 font-['Poppins'] font-bold text-[#4DD0E1] hover:gap-3"
              >
